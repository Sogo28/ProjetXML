<div class="w-full text-black flex flex-row gap-4 px-4 py-2 justify-between bg-white items-center shadow shadow-lg">
  <div>
    <a href="index.php" class="px-2 text-sm italic font-bold border-r-2 border-black">SenFilms</a>
    <a href="index.php" class="px-2 text-sm italic font-bold">SenRestaurants</a>
  </div>
